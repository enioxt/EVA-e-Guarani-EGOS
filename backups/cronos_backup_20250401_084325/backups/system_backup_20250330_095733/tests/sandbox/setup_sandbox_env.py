...
def check_sandbox_structure():
    ...
    essential_dirs = ["api/flask_api", "frontend/html_basic", "examples", "tools", "docs"]
    ...
    essential_files = [
        (
            "requirements.txt",
            "# EVA & GUARANI Sandbox - Requirements\n\n"
            + "# Web Frameworks\n"
            + "flask>=2.0.1\n"
            + "flask-cors>=3.0.10\n\n"
            + "# Utilities\n"
...
def check_for_run_script():
    ...
    if not py_file.exists():
        ...
        with open(py_file, "w", encoding="utf-8") as f:
            ...
            f.write(
                '    flask_process = subprocess.Popen([sys.executable, "-m", "flask", "run", "--debug"])\n\n'
            )
