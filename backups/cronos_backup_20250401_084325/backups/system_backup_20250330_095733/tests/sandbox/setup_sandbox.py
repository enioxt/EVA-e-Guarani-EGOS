...
DIRECTORY_STRUCTURE = {
    "api": {"flask_api": {}, "django_api": {"sandbox_project": {"sandbox_app": {}}}},
    "frontend": {
        "html_basic": {},
        "react_app": {"public": {}, "src": {"components": {}, "styles": {}}},
        "vue_app": {"public": {}, "src": {"components": {}, "assets": {}}},
    },
    "examples": {"api_usage": {}, "frontend_examples": {}, "integration": {}},
    "data": {"sample": {}, "temp": {}},
    "docs": {"diagrams": {}, "api": {}, "tutorials": {}},
}
        ...
        if not files and root_path != base_path:
            ...
            if not readme_path.exists():
                with open(readme_path, "w", encoding="utf-8") as f:
                    ...
                    f.write("## Description\n\n")
                    f.write(
                        "Add a description about the files and purpose of this directory here.\n\n"
                    )
