...
@echo off
REM EVA & GUARANI - Cursor IDE Quantum Integration
REM Version: 7.5
REM Created: 2025-03-26

echo ✧༺❀༻∞ EVA & GUARANI - Cursor IDE Integration ∞༺❀༻✧
echo.
echo Starting Cursor IDE Quantum Integration...
echo.
...
REM Run the Cursor Integration in monitoring mode (update every 5 minutes)
%PYTHON_CMD% cursor_quantum_integration.py --monitor 300
