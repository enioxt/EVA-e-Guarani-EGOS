...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("logs/quantum_knowledge_test.log"), logging.StreamHandler()],
)
...
class QuantumKnowledgeTester:
    ...
    def check_files(self) -> bool:
        ...
        """
        required_files = ["quantum_knowledge_hub.py", "quantum_knowledge_integrator.py"]
