...
Welcome to EVA & GUARANI - A Quantum Unified System for Knowledge Integration and Evolution.
...
Please refer to the [Installation Guide](docs/INSTALLATION_GUIDE.md) for setup instructions.
