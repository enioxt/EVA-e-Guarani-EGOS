...
class MetricsCollector:
    ...
    def __init__(self):
        ...
        self.total_nodes = Gauge(
            'eva_guarani_total_nodes',
            'Total number of nodes in the Mycelium network'
        )
        
        self.active_connections = Gauge(
            'eva_guarani_active_connections',
            'Number of active connections in the Mycelium network'
        )
        ...
        self.system_info = Info(
            'eva_guarani_system',
            'EVA & GUARANI system information'
        )
        
        # Memory usage
        self.memory_usage = Gauge(
            'eva_guarani_memory_bytes',
        ...
        try:
            ...
            if mycelium and mycelium.node:
                ...
                total_connections = sum(
                    ...
                    for node in mycelium.nodes.values()
                )
            ...
            "dashboard": {
                ...
                "panels": [
                    ...
                    },
                    {
                        ...
                        "datasource": "Prometheus",
                        "targets": [
                            {"expr": "rate(eva_guarani_search_requests_total[5m])"}
                        ]
                    },
                    {
                        ...
                        "datasource": "Prometheus",
                        "targets": [
                            {"expr": "rate(eva_guarani_translation_requests_total[5m])"}
                        ]
                    },
                    {
            ...
            async with aiohttp.ClientSession() as session:
                ...
                async with session.post(
                    ...
                    if response.status == 200:
                        ...
                        logger.error(
                            f"Error creating Grafana dashboard: {response.status}"
                        )
