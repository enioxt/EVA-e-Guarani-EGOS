...
Examples:
  ...
  %(prog)s migrate-bios-q            Migrate BIOS-Q to QUANTUM_PROMPTS
    ...
    restore_parser = quarantine_subparsers.add_parser('restore', help='Restore file from quarantine')
    ...
    migrate_parser = subparsers.add_parser('migrate-bios-q', help='Migrate BIOS-Q to QUANTUM_PROMPTS')
