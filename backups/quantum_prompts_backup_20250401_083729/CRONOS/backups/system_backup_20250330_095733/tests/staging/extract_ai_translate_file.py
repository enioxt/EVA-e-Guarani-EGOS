#!/usr/bin/env python3
# Important content extracted from sandbox\tools\ai_translate_file.py
...
class AITranslator:
    ...
    def translate_file(self, input_path: Path, output_path: Optional[Path] = None,
...
```"""
        ...
        try:
            ...
            response = self.client.chat.completions.create(
                model=self.model,
                messages=[
                    {"role": "system", "content": "You are a professional translator specializing in Portuguese to English technical translation, maintaining code integrity and functionality."},
...
def main():
    ...
    parser.add_argument("--output", type=str, help="Output file (if not specified, will replace original)")
