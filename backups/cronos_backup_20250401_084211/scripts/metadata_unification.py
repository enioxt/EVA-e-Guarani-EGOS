...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("metadata_unification.log"), logging.StreamHandler(sys.stdout)],
)
...
class MetadataUnification:
    ...
    def create_target_structure(self) -> bool:
        ...
        """
        try:
            directories = ["core", "config", "scripts", "tests", "docs", "backups", "metrics"]
    ...
    def move_files(self) -> bool:
        ...
        try:
            ...
            # Move test files
            test_files = ["tests/test_metadata_manager.py", "tests/test_filesystem_monitor.py"]
            ...
            config_files = {"requirements.txt": "requirements.txt", "README.md": "docs/README.md"}
        ...
        try:
            ...
            for file_path in files_to_update:
                ...
                content = content.replace(
                    "from .metadata_manager", "from QUANTUM_PROMPTS.METADATA.core.metadata_manager"
                )

                # Update other references
                content = content.replace("METADATA/", "QUANTUM_PROMPTS/METADATA/")
