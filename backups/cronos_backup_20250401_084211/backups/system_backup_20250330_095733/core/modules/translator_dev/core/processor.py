...
class TranslationProcessor:
    ...
    def translate_files(self, files: List[str], output_dir: Optional[str] = None, 
                      engine_name: str = "huggingface", workers: int = 2,
    ...
    def _translate_file(self, file_path: str, translate_fn: Callable, 
