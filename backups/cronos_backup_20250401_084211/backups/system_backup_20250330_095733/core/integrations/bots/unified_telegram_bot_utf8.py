...
- Context and awareness management
- Ethical and responsive processing
- Interactive interface with intuitive menus
- Adaptive selection of AI models
...
try:
    ...
    from .ethik_core import EthikCore, EthicalContext
    from .adaptive_model_selector import AdaptiveModelSelector
    from .interactive_ui import InteractiveUIManager, TelegramUIBuilder
except ImportError:
