...
class StableDiffusionAPI:
    ...
    def __init__(self, api_key: Optional[str] = None, api_url: Optional[str] = None):
        ...
        self.has_stable_diffusion_api = bool(self.api_key and self.api_url and 
                                             self.api_key != "sua_chave_api_aqui" and 
                                             self.api_url != "https://api.exemplo.com/images")
    ...
    async def generate_image(self, 
                             ...
                             steps: int = 30,
                             seed: int = -1) -> Tuple[bool, Optional[str], Optional[bytes]]:
        """
    ...
    async def _generate_with_local_api(self, 
                                      prompt: str, 
                                      negative_prompt: str,
                                      width: int, 
                                      height: int, 
                                      ...
                                      steps: int,
                                      seed: int) -> Tuple[bool, Optional[str], Optional[bytes]]:
        ...
        try:
            ...
            response = await loop.run_in_executor(
                ...
                lambda: requests.post(
                    url=f'{self.local_api_url}/sdapi/v1/txt2img',
                    json=payload,
                    timeout=120
                )
            )
    ...
    async def _generate_with_remote_api(self, 
                                       prompt: str, 
                                       negative_prompt: str,
                                       width: int, 
                                       height: int, 
