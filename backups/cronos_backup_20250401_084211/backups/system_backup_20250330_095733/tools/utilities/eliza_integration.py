...
class ElizaIntegration:
    ...
    def __init__(self, telegram_config_path: str = "config/telegram_config.json", 
...
class ElizaBot:
    ...
    def register_message_handler(self, handler: Callable, content_types: Optional[List[str]] = None) -> None:
        """
...
def create_text_response(chat_id: int, text: str, reply_to_message_id: Optional[int] = None, 
...
def create_photo_response(chat_id: int, photo: str, caption: Optional[str] = None,
