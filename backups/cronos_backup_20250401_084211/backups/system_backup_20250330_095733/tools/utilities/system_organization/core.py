...
class SystemOrganizer:
    ...
    def organize_directory(self, directory_map: Dict[str, str]) -> Tuple[int, List[Tuple[str, str]]]:
    ...
    def organize_system(self) -> bool:
        ...
        try:
            ...
            for directory_map in [self.CORE_DIRS, self.MODULE_DIRS, 
                                self.INTEGRATION_DIRS, self.TOOL_DIRS]:
