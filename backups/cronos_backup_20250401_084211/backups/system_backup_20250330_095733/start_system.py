...
def start_metadata_system():
    ...
    try:
        # Start scanner
        scanner_process = subprocess.Popen([sys.executable, os.path.join(metadata_dir, 'scanner.py')])
        
        # Start tracker
        tracker_process = subprocess.Popen([sys.executable, os.path.join(metadata_dir, 'tracker.py')])
        
        # Start organizer
        organizer_process = subprocess.Popen([sys.executable, os.path.join(metadata_dir, 'organizer.py')])
