...
def main():
    ...
    parser.add_argument('--dry-run', action='store_true', help='Show proposed changes without executing them')
    parser.add_argument('--track-usage', action='store_true', help='Start tracking file usage')
    parser.add_argument('--days', type=int, default=30, help='Number of days to look back for usage stats')
