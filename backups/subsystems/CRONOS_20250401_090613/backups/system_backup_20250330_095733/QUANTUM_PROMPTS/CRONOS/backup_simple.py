...
excluded_dirs = ['node_modules', '.venv', 'venv', 'quarantine', '__pycache__', '.git', '.idea', '.vscode', 'dist', 'build']
...
print(f'✅ Backup concluído! Arquivos copiados: {files_copied}, Arquivos ignorados: {files_skipped}')
