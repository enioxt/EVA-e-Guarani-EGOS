...
def migrate_user_data():
    ...
    if not WHATSAPP_DATA_DIR.exists():
        logger.warning("Diretório de dados do WhatsApp não encontrado. Pulando migração de usuários.")
        return
    ...
    for user_file in user_files:
        try:
            ...
            whatsapp_id = whatsapp_user_data.get("id", os.path.basename(user_file).replace(".json", ""))
