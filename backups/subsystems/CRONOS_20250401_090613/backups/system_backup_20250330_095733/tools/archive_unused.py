...
def main():
    parser = argparse.ArgumentParser(description="Archive unused directories in EVA & GUARANI project")
    parser.add_argument("--archive-dir", help="Directory where to archive files")
    parser.add_argument("--delete", action="store_true", help="Delete directories instead of archiving")
    parser.add_argument("--list", action="store_true", help="List recommended directories to archive")
