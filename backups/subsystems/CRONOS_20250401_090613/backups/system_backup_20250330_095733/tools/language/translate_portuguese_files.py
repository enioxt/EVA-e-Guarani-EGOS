...
class PortugueseDetector:
    ...
    def __init__(self):
        self.portuguese_patterns = [
            r'\bção\b', r'\bções\b', r'\bção\s', r'\bções\s',
            r'\bcao\b', r'\bcao\s', r'\bcoes\b', r'\bcoes\s',
            r'\baçao\b', r'\baçao\s', r'\baçoes\b', r'\baçoes\s',
            r'\bçao\b', r'\bçao\s', r'\bçoes\b', r'\bçoes\s',
            r'\bde\s+a\b', r'\bda\b', r'\bdo\b', r'\bdos\b', r'\bdas\b',
            r'\bpara\s+o\b', r'\bpara\s+a\b', r'\bpara\s+os\b', r'\bpara\s+as\b',
            r'\bcomo\s+usar\b', r'\bcomo\s+fazer\b', r'\bcomo\s+implementar\b',
            r'\bpróximo\b', r'\bpróxima\b', r'\bpróximos\b', r'\bpróximas\b',
            r'\bfunção\b', r'\bfunções\b', r'\baplicação\b', r'\baplicações\b',
            r'\bpadrão\b', r'\bpadrões\b', r'\bautomatização\b', r'\bintegração\b',
            r'\bimplementação\b', r'\bmanutenção\b', r'\batualização\b',
            r'\bcódigo\b', r'\btradução\b', r'\banotação\b', r'\bvariável\b',
            r'\bconfigurações\b', r'\butilizando\b', r'\bprocessamento\b',
            r'\bcomunicação\b', r'\bsistemas\b', r'\bestrutura\b',
            # Portuguese-specific words with accents
            r'\bé\b', r'\bestá\b', r'\bestão\b', r'\bnão\b', r'\bmás\b',
            r'\bportuguês\b', r'\binglês\b'
        ]
        self.portuguese_words = {
            'não', 'sim', 'como', 'porque', 'quando', 'onde', 'quem', 'qual', 'quais',
            'para', 'por', 'pelo', 'pela', 'pelos', 'pelas', 'com', 'sem', 'entre',
            'sobre', 'sob', 'desde', 'até', 'durante', 'após', 'antes',
            'mas', 'porém', 'contudo', 'todavia', 'entretanto', 'então', 'portanto',
            'assim', 'embora', 'apesar', 'conforme', 'segundo', 'consoante',
            'este', 'esta', 'estes', 'estas', 'esse', 'essa', 'esses', 'essas',
            'isto', 'isso', 'aquele', 'aquela', 'aqueles', 'aquelas', 'aquilo'
        }
        self.compiled_patterns = [re.compile(pattern, re.IGNORECASE) for pattern in self.portuguese_patterns]
...
class PortugueseToEnglishTranslator:
    ...
    def _load_translation_memory(self):
        ...
        if memory_path.exists():
            try:
                ...
                logger.info(f"Loaded {len(self.translation_memory)} entries from translation memory")
    ...
    def process_directory(self, dir_path: Path, extensions: List[str], rename_files: bool = False, rename_dirs: bool = False) -> Dict[str, int]:
        """
...
def main():
    """Main entry point"""
    parser = argparse.ArgumentParser(description="EVA & GUARANI EGOS - Portuguese to English File Translator")
    
    parser.add_argument("-d", "--directory", type=str, default=None,
                       help="Directory to process (default: current project root)")
    
    parser.add_argument("-e", "--extensions", type=str, default=".txt,.md,.py,.js,.json",
    ...
    parser.add_argument("--rename-files", action="store_true",
                       help="Rename files with Portuguese names")
    
    parser.add_argument("--rename-dirs", action="store_true",
                       help="Rename directories with Portuguese names")
