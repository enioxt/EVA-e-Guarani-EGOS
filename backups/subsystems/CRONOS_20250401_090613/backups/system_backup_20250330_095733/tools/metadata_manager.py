...
logging.basicConfig(
    level=logging.INFO,
    format='%(asctime)s - %(levelname)s - [METADATA-MANAGER] %(message)s'
)
...
class MetadataManager:
    ...
    IGNORED_DIRS = {
        ...
        'temp', 'logs', 'Backups', 'quarentena', '.pytest_cache',
        '.cursor', '.obsidian', 'dist'
    }
    ...
    def generate_report(self) -> str:
        ...
        success_rate = (self.files_updated / self.files_processed * 100) if self.files_processed > 0 else 0
