...
class ConfigCore:
    ...
    def create_group(self, name: str, type: ConfigType, description: str,
    ...
    def set_value(self, group_id: str, key: str, value: Any, description: str,
    ...
    def export_group(self, group_id: str, format: ConfigFormat = ConfigFormat.JSON) -> Optional[str]:
