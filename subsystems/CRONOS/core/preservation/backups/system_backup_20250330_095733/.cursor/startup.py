    ...
    if os.path.exists(QUANTUM_PROMPT):
        ...
        if os.path.exists(CONFIG_PATH):
            try:
                ...
                if config and config.get("system", {}).get("core_principles_file") == QUANTUM_PROMPT:
        ...
        if os.path.exists(CHANGELOG_FILE):
            try:
                ...
                if pending_count > 0:
                    ...
                    print("   Use 'python core/quantum_changelog.py' e selecione a opção 2 para revisar")
