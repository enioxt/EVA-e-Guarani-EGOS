...
class PerplexityIntegration:
    ...
    def _process_for_quantum_system(self, results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        quantum_results = {
            ...
            "metadata": {
                ...
                "confidence_score": results.get("validation_metadata", {}).get("confidence_score", 0.7),
    ...
    def _estimate_source_reliability(self, source: Dict[str, Any]) -> float:
        ...
        sensational_terms = ["unbelievable", "shocking", "you won't believe", 
                            "revealed", "secret", "exclusive", "surprising"]
...
if __name__ == "__main__":
    try:
        ...
        if results["status"] == "success":
            ...
            content_preview = str(results["content"])[:300] + "..." if len(str(results["content"])) > 300 else str(results["content"])
