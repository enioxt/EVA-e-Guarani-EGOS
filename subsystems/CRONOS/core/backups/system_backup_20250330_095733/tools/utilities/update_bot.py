...
def main():
    ...
    parser.add_argument('--check-only', action='store_true', help='Only check for updates, do not apply them')
    parser.add_argument('--force', action='store_true', help='Force update even if no changes are detected')
    parser.add_argument('--no-restart', action='store_true', help='Do not restart the bot after updating')
