...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("quarantine.log"),
        ...
        self.duplicate_patterns = [
            {
                ...
                "duplicates": [
                    "core/ethik/ethik_core_1.py",
                    "core/ethik/ethics.py"
                ]
            },
            {
            ...
            },
            {
                ...
                "duplicates": [
                    "BIOS-Q/BIOS_Q/cursor_integration.py"
                ]
            },
            {
                "primary": "tools/scripts/context_manager.py",
                "duplicates": [
                    "BIOS-Q/BIOS_Q/context_manager.py"
                ]
            },
            {
                "primary": "tools/integration/cursor_atlas_bridge.py",
                "duplicates": [
                    "integrations/platforms/integrate_quantum_knowledge.py"
                ]
            },
            {
                "primary": "start_bios_q.bat",
                "duplicates": [
                    "BIOS-Q/start_cursor_bios.bat"
                ]
            }
        ]
...
def main():
    """Main entry point"""
    parser = argparse.ArgumentParser(description="EVA & GUARANI EGOS - Duplicate File Quarantine Tool")
