...
@app.route('/api/test')
def test():
    """Test route to demonstrate debug mode"""
    # Get custom message from query string (if exists)
    custom_message = request.args.get('message', 'Hello! This is a test message from EVA & GUARANI!')
    ...
    return jsonify({
        ...
        "status": "online",
        "version": "1.0.0",
        "active_modules": ["ATLAS", "NEXUS", "CRONOS", "ETHIK"],
        "last_update": "2024-03-21T10:00:00"
    })
