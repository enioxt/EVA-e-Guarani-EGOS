...
@patch("subsystems.ETHIK.service.EthikValidator", new_callable=MagicMock) # Use MagicMock for sync class
@patch("subsystems.ETHIK.service.EthikSanitizer", new_callable=MagicMock) # Use MagicMock for sync class
def test_service_initialization(mock_sanitizer_cls, mock_validator_cls, test_config, mock_mycelium, project_root):
...
async def test_service_start(mock_sanitizer_cls, mock_validator_cls, test_config, mock_mycelium, project_root):
...
@patch("subsystems.ETHIK.service.EthikValidator", new_callable=MagicMock)
@patch("subsystems.ETHIK.service.EthikSanitizer", new_callable=MagicMock)
async def test_service_stop(mock_sanitizer_cls, mock_validator_cls, test_config, mock_mycelium, project_root):
...
@patch("subsystems.ETHIK.service.EthikValidator", new_callable=MagicMock)
@patch("subsystems.ETHIK.service.EthikSanitizer", new_callable=MagicMock)
async def test_service_start_stop_idempotency(mock_sanitizer_cls, mock_validator_cls, test_config, mock_mycelium, project_root):
